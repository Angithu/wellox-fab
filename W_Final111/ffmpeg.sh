...
{
ffmpeg -y -ss 00:00:00 -t $Time -f mjpeg -i "http://127.0.0.1:8006/?action=stream" -q:v 5 -filter:v "setpts =0.858*PTS"  -maxrate:v 400k -bufsize:v 600k -an  /home/smg/SSDLoader/WELLOX/video5_$now.mp4
}&wait
INDEX=0
Flag=1
while : #[ $INDEX -le $Flag]
...
{
#ffmpeg -y -ss 00:00:00 -t 00:59:59.55 -f mjpeg -i "http://127.0.0.1:8006/?action=stream" -q:v 5 -filter:v "setpts =0.85*PTS" -maxrate:v 600k -bufsize:v 600k -an -an ./video5_$n.mp4
